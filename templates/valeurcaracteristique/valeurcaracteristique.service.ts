...
export class ValeurCaracteristiqueService extends BamboAbstractService {
  ...
  constructor(public httpSrv: BamboHttpService,
    ...
    this.setRoutePrefix('valeurcaracteristique');
    this.setResourceName('VALEURCARACTERISTIQUE');
  }
