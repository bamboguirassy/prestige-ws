...
export class CaracteristiqueCategorieService extends BamboAbstractService {
  ...
  constructor(public httpSrv: BamboHttpService,
    ...
    this.setRoutePrefix('caracteristiquecategorie');
    this.setResourceName('CARACTERISTIQUECATEGORIE');
  }
