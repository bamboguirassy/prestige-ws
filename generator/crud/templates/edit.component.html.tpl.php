<div class="card" *ngIf="resourceName|editable">
    <h1 class="mb-0">Formulaire de Modification - <?= $entity_class_name ?></h1>
    <hr class="mb-0">
    <form (ngSubmit)="updateItem()" #<?= $entity_var_singular ?>Form="ngForm">
        <div class="card-body">
            <div class="row">
        ...
        <div class="card-footer">
            ...
            <button *ngIf="resourceName|editable" icon="pi pi-pencil" pButton [disabled]="isSubmitted || <?= $entity_var_singular ?>Form.invalid || isOffline" type="submit"
                class="float-md-right ml-1 mt-1" label="Mettre à jour">
